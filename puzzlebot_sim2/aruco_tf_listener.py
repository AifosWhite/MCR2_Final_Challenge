...
This node listens to a TF transform between the robot base and a marker
frame and prints distance/bearing. Useful to validate that aruco_ros is
publishing marker frames before enabling EKF correction.
"""
